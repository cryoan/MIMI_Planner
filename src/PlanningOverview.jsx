...
const PlanningOverview = ({ customScheduleData, onPeriodClick }) => {
  ...
  const getPeriods = () => {
    ...
    // Return periods sorted numerically (P1, P2, P3, ...)
    return Object.keys(customScheduleData.periodicSchedule)
      .sort((a, b) => {
        // Extract numbers from "P1", "P2", etc. and sort numerically
